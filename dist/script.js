...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var feedBackSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_6__["default"](".feedback-slider", {
    spaceBetween: 30,
    centeredSlides: true,
    autoplay: {
      delay: 2500,
  ...
  new wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_7___default.a.WOW().init();
});
...
function workAccordion(triggerSelector, contentSelector, activeTriggerClass, activeContentClass) {
  ...
  contents.forEach(function (item) {
    item.style.display = 'none'; // item.style.transition = '.5s all';
...
function workHover(wrapperContentSelector, notHideElemClass) {
  var wrapperContent = document.querySelectorAll(wrapperContentSelector);
  var img, src;
  wrapperContent.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (workHover);
